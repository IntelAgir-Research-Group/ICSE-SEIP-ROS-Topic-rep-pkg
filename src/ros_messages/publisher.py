...
def create_publisher_node(msg_type, topic_name, msg_type_str, msg_size, interval):
...
def main():
    ...
    parser.add_argument('--message_size', type=int, required=True, help='Message size (1, 2, or 3)')
    ...
    rclpy.init()
    pub_node_class = create_publisher_node(msg_type, topic_name, args.message_type, args.message_size, args.interval)
